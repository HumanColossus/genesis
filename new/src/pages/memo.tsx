    ...
    <main className="mt-4 flex justify-center px-4">
      <div className="max-w-custom">
        ...
        <p className={paragraph}>
          ...
          groups, and online accelerators. We’re inspired by our experiences on platforms like Pioneer, communities like the Gen Z Mafia, and the young builder
        ...
        <p className={paragraph}>
          ...
          just direction on where to find existing resources. We don’t need to supplement the countless courses, videos, textbooks, and articles already out
          there, for free!
        </p>
        <p className={paragraph}>
        ...
        <p className={paragraph}>
          ...
          builders on the waitlist. <span className="text-[#747485] italic">You can sign up for the waitlist below.</span>
        </p>
        <p className={paragraph}>
        ...
        <div className="flex justify-between mt-4">
          ...
          <button
            ...
            onClick={() => window.open("https://www.getwaitlist.com/waitlist/3960")}
          >
            Join waitlist
          </button>
          <button
              ...
              <div className="flex justify-between static" key={i}>
                <div className="flex shrink-0">
                  ...
                  <div className="flex flex-col justify-between mx-3">
                    ...
                    <div className="flex mt-0 gap-2 font-mono" style={{ fontSize: "12px", marginTop: "0px", lineHeight: "16.5px", color: "#CCCCD2" }}>
                      <p style={{ color: "rgb(116, 116, 133)" }}>in</p>
                      <p className={clsx({ "text-[#e1b13e]": signature.gold })}>{signature.subject}</p>
                      <p>/</p>
                      <p>{signature.age}</p>
        ...
        <div className="bg-[#00001c] rounded-lg mt-5 mb-6 pb-4 pt-1.5 shadow-custom px-4">
          <h1 className="w-full bg-[#00001c] z-10 pt-1 font-semibold	">Get involved!</h1>
