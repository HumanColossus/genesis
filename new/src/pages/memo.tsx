  ...
  return (
    <main className="mt-4 flex justify-center px-4">
      <div className="max-w-custom">
        ...
        <h1 className="mt-6 mb-4 text-4xl font-bold text-white">A worldwide education platform for the self-motivated.</h1>
        ...
        <p className={paragraph}>
          ...
          builders on the waitlist. <span className="italic text-[#747485]">You can sign up for the waitlist below.</span>
        </p>
        <p className={paragraph}>
        ...
        <div className="mt-4 flex justify-between">
          <button
            ...
            onClick={() => {
              ...
              window.open("https://fepmaftot5b.typeform.com/to/YgUcfdxu");
            }}
          >
            Apply to join
          </button>
            ...
            {signatures.map((signature, i) => (
              <div className="static flex justify-between" key={i}>
                ...
                <div style={{ width: "80px" }}>
                  <Image src={signature.signature} alt="The human colossus logo" layout="intrinsic" className="relative rounded" />
                </div>
              </div>
            ))}
          </div>
