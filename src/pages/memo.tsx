...
import { MarqueeLayout } from "../components/basics";
        ...
        <div className="mx-auto flex max-w-custom flex-col gap-0 px-4 pt-4">
          ...
          <p className={paragraph}>
            <span className={highlight}>
              The next generation of builders is self-taught, and already
              building the future, right now.
            </span>{" "}
            Most began online, watching Youtube videos, building web apps,
            reading articles, joining professional communities, shipping
            products, while underserved by institutional education.
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>
            ...
            self-motivated education as the true alternative it is, and build
          ...
          <div className="my-2 flex gap-3.5">
            ...
            <p>
              ...
              building a better educational system for young people, and get
              them competing for, contributing to, and founding the future.
            </p>
          </div>
          <p className={paragraph}>
            <span className="bg-[#30267c]">
            ...
            , as members of early Discord communities, Twitter groups, and
            online accelerators. We’re inspired by our experiences on platforms
            like Pioneer, communities like the Gen Z Mafia, and the young
          ...
          <p className={paragraph}>
            ...
            ; knowing where to find answers to questions, finding alternatives,
            or overcoming obstacles is a skill that develops with age.
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>
            👉 &nbsp; We’re rewarding users who follow the two-week learn,
            teach, publish pattern, where writing out learnings to teach others
            allows a form of direct application + tangible value to the world.{" "}
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>
            🚨 It&apos;s hard if your progress doesn&lsquo;t show results or
            feel rewarding.
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>
            🚨 It&apos;s hard if there isn&apos;t a strong reason
            &quot;why&quot; one is learning.
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>
            ...
            <span className="bg-[#30267c]">
              Every great builder cites a certain community that helped them
              along their way.
            </span>
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>
            👉 &nbsp; We’re building a network of builders, from just starting
            to just raised a Series C, worldwide.
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>
            To start, we’ve built a platform for existing builders who are
            already creating & learning at high speed. You can meet some of our
            members below!
          </p>
          <p className={paragraph}>
          ...
          <p className="mt-14 mb-14 p-4 font-mono text-csm italic leading-5 text-[#747485]">
            ...
            organization and aims to represent all builders of all backgrounds.
            We recognize the STEM gender gap and are committed to fighting for
            better gender representation in our organization and the space at
            large.
          </p>
        </div>
      </MarqueeLayout>
