      ...
      <Container title="/ Builder Stories">
        <ScrollableWrapper>
          <div className="flex flex-col gap-3.5">
            ...
            />
            <BuilderStory title="Releasing on September 14th." image={WillShaded} description="????? ?? ?????? ??????" name="???? ?????" />
            <BuilderStory title="Releasing on September 24th." image={MiguelShaded} description="????? ??? ??????????" name="????? ?????????" />
            {/* <BuilderStory
